...
def check_income(wizard):
    ...
    form_data = wizard.get_cleaned_data_for_step(STEP_FIVE)
...
class FormWizardView(SessionWizardView):
    ...
    condition_dict = {
        ...
        STEP_SIX: check_income,
        STEP_SEVEN: check_income,
        STEP_EIGHT: check_income_2,
        STEP_NINE: check_income_2,
    }
...
def denail(request, type):
    if type == "age":
        template = loader.get_template("msrs/forms/screening_neg_age.html")
    elif type == "gender":
        template = loader.get_template("msrs/forms/screening_not_gender.html")
    elif type == "locality":
        template = loader.get_template("msrs/forms/screening_not_locality.html")
    elif type == "income":
        template = loader.get_template("msrs/forms/screening_not_income.html")
