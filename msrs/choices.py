...
PHYSICAL_VIOLENCE_CHOICES = (
        ...
        ('Facada', 'Facada'),
        ('Me exigiu práticas sexuais que eu não gosto', 'Me exigiu práticas sexuais que eu não gosto'),
        ('Fui forçada à alguma prática sexual na intenção de corrigirem minha orientação sexual', 'Fui forçada à alguma prática sexual na intenção de corrigirem minha orientação sexual'),
...
PSYCH_VIOLENCE_CHOICES = (
        ...
        ('Tive minha identidade inviabilizada e negada', 'Tive minha identidade inviabilizada e negada'),
        ('Fui isolada', 'Fui isolada'),
        ('Não me permitiu usar certos tipos de roupa', 'Não me permitiu usar certos tipos de roupa'),
        ('Fui xingada', 'Fui xingada'),
        ('Fui desautorizada', 'Fui desautorizada'),
        ('Não me deixou trabalhar', 'Não me deixou trabalhar'),
        ('Me negou o direito a métodos contraceptivos', 'Me negou o direito a métodos contraceptivos'),
        ...
        ('Não estou sofrendo violência psicológica', 'Não estou sofrendo violência psicológica'),
    )
...
DIGITAL_VIOLENCE_CHOICES = (
        ('Tive vazamento/compartilhamento na internet de minhas informações pessoais e dados sem meu consentimento', 'Tive vazamento/compartilhamento na internet de minhas informações pessoais e dados sem meu consentimento'),
        ('Tive vazamento/compartilhamento na internet de minhas imagens íntimas', 'Tive vazamento/compartilhamento na internet de minhas imagens íntimas'),
        ('Sofri stalking online (perseguição ou observação obsessiva)', 'Sofri stalking online (perseguição ou observação obsessiva)'),
...
PROPERTY_VIOLENCE_CHOICES = (
        ...
        ('Me impediu de ter acesso a conta bancária ou outros bens', 'Me impediu de ter acesso a conta bancária ou outros bens'),
        ('Não estou sofrendo violência patrimonial', 'Não estou sofrendo violência patrimonial'),
)

OBSTETRIC_VIOLENCE_CHOICES = (
        ('Alteraram o processo natural do parto sem meu consentimento voluntário', 'Alteraram o processo natural do parto sem meu consentimento voluntário'),
        ('Sofri abusos e maus-tratos durante a minha gestação', 'Sofri abusos e maus-tratos durante a minha gestação'),
        ('Sofri abusos e maus-tratos no momento do meu parto', 'Sofri abusos e maus-tratos no momento do meu parto'),
        ('Não estou sofrendo violência obstétrica', 'Não estou sofrendo violência obstétrica'),
)
...
REGISTER_RISK_CHOICES = (
  ...
  ('Estou em cárcere privado', 'Estou em cárcere privado'),
  ('Ocorreu em ambiente público (internet, rua, etc)', 'Ocorreu em ambiente público (internet, rua, etc)'),
  ('Ocorreu em ambiente de trabalho', 'Ocorreu em ambiente de trabalho'),
  ('O(A) autor(a) tem diagnóstico de doença psiquiátrica', 'O(A) autor(a) tem diagnóstico de doença psiquiátrica'),
  ('O(A) autor(a) faz uso de substância psicoativa', 'O(A) autor(a) faz uso de substância psicoativa'),
  ('Dependo financeiramente do(a) autor(a) da violência', 'Dependo financeiramente do(a) autor(a) da violência'),
  ('Tive acesso negado aos serviços públicos de atendimento à mulher', 'Tive acesso negado aos serviços públicos de atendimento à mulher'),
