...
class IntegrationLogs(models.Model):
  ...
  form_type = models.CharField( max_length=15,blank=True, choices = (("psicologa", "Psicóloga"), ("advogada", "Advogada"), ("msr","Msr")))
...
class Volunteer(models.Model): 
  ...
  latitude = models.DecimalField("Latitude", max_digits=10, decimal_places=4,blank=True,null=True)
  logintude = models.DecimalField("Longitude", max_digits=10, decimal_places=4,blank=True,null=True)
  ...
  years_of_experience = models.CharField( max_length=100,blank=True, choices = YEARS_OF_EXPERIENCE_CHOICES)
  aviability = models.CharField( max_length=100,blank=True, choices = AVAILABILITY_CHOICES )
  approach = models.CharField( max_length=100,blank=True,null=True, choices = APPROACH_CHOICES) 
